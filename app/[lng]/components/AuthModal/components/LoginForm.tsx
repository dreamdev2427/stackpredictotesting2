    ...
    <div className="flex relative h-screen">
      ...
      <div className="w-9/12 relative">
        <div className="flex items-center pl-7 h-screen">
          {/* <p className="text-xl text-white text-center z-10 font-bold overflow-hidden">
            {randomPhrase}
          </p> */}
            <div className="w-max">
            <p className="animate-typing overflow-hidden whitespace-nowrap text-xl text-white text-center z-10 font-bold">{randomPhrase}</p>
            </div>
        </div>
      </div>
